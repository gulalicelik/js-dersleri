...
// // Task  yukarıdaki products array'ini kullanarak aşağıdaki soruları çözünüz
//
// // 0) tüm ürünkerin title alanlarını konsola yazdırınız (forEach ile)
// products.forEach(product => {
//     console.log(product.title)
// })
// // 1) Ürünlerin fiyat ortalaması nedir? (forEach ile)
// let total = 0
// products.forEach(product => {
//     total += product.price
// })
// console.log(total / products.length)
// // 2) Ürünlerden hangisinin fiyatı 500'den büyüktür? (forEach ile & filter ile)
// const myFilteredList  =[];
// products.forEach(product => {
//     if (product.price > 500) {
//         myFilteredList.push(product)
//     }
// })
// console.log(myFilteredList)
//
// const filteredList = products.filter(product => product.price > 500)
// console.log(filteredList)
//
// // 3) Markası apple olan ürünlerin isimleri nelerdir?
const appleProducts = products.filter(product => product.brand === 'Apple')
// console.log(appleProducts)
// // 4) her bir ürüne size alanı ekleyin ve bu alan random bir sayı olsun sonunda yeni bir dizi elde edin ve ekrana yazdırın
//
// const newProducts = products.map(product => {
//     product.size = Math.floor(Math.random() * 10)
//     return product
// })
...
function  mutfak(){
    console.log('Yemek yapılıyor')
}
function banyo(){
    console.log('Banyo yapılıyor')
}
function yatak(){
    console.log('Yatılıyor')
}
function calisma(){
    console.log('Çalışılıyor')
}
function spor(){
    console.log('Spor yapılıyor')
}
...
// TASK 1 KİŞİSEL BİLGİLERİNİSİ CONSOLE YAZDIRAN BİR FONKSİYON OLUŞTURUNUZ (AD, SOYAD, DOĞUM TARİHİ, MESLEK, TELEFON)

// function personalInfo() {
//     console.log('Ad: Ahmet')
//     console.log('Soyad: Yılmaz')
//     console.log('Doğum Tarihi: 1990')
//     console.log('Meslek: Developer')
//     console.log('Telefon: 123456789')
// }
//
//
// personalInfo();
...
// function printPersonInformations(firstname, lastname, age, city, phone) {
...
// }
//
// printPersonInformations('Ahmet', 'Yılmaz', 30, 'İstanbul', '123456789');
// printPersonInformations('Mehmet', 'Yılmaz', 35, 'Ankara', '987654321');
// printPersonInformations('Ayşe', 'Yılmaz', 25, 'İzmir', '123456789');
// printPersonInformations('Fatma', 'Yılmaz', 40, 'Bursa', '987654321');
// printPersonInformations('Hayriye', 'Yılmaz', 50, 'Antalya', '123456789');
//
// // TASK : 2 sayıyı toplayan bir fonksiyon oluşturunuz (sayıları parmetre olarak gönderiniz)
//
...
// addTwoNumbers(25, 10);
//
// // TASK : öğrennini vize ve final notlarını alıp ortalama hesaplayan bir fonksiyon oluşturunuz
//
...
// calculateAverage(70, 60);
// calculateAverage(90, 100);

// TASK öğrencinin ortalamansını hesaplayan ve geri döndüren bir fonksiyon oluşturunuz (return)
...
// const avarege = (vize, final) => vize * 0.4 + final * 0.6)
var ort = calculateAverage(80, 90);
console.log(ort)
console.log(calculateAverage(80, 90));

// ödev override ve overload nedir ?

// TASK: iki sayıyı toplayan bir fonksiyon oluşturunuz değerlerin toplamını geri döndürsün

function addTwoNumbers(number1, number2) {
    return number1 + number2
}
let toplam = addTwoNumbers(5, 10);
console.log(toplam)

// TASK products array'ini kullanarak aşağıdaki soruları çözünüz

// kendisine parametre olarak bir ürün objesi alan bir fonksiyon yazınız
// bu fonsiyon ürünün filedları arasına ürünün fiyatını dolar cinsine çevirip eklesin (doları 30dan alabilirsin
// eklenen ürünü geri döndürsün
// geri döndüpünde her ürünğn içinde dolay cinsindan fiyatı farklı bir key ile görünsün (priceDolar)

// boş dizi oluşturun
// fonksiyon oluşuturun (ürünü parametre olarak alabilen ve alanı ekleyen)
// products array'ini dönün ve her bir ürünü bu fonksiyona gönderin ve dönen değeri bu diziye ekleyin

const productsWithDollar = [];

function addDollarPrice(product) {

}

const addDollarPrice = (products) => {
    product.priceDollar = product.price / 30;
    return product
}
products.forEach(product => {
    productsWithDollar.push(addDollarPrice(product))
})
console.log(productsWithDollar)

const newProducts =products.map(product => {
    return addDollarPrice(product)
})

// diğer fonksiyon tanımlama şekilleri
...
const addTwoNumbers = (number1, number2) => number1 + number2;
 const calculate = number1 => number1 * 2;
